...
document.getElementById("origin").addEventListener("submit", submitForm);
document.getElementById("origindetail1").addEventListener("input", (e) => {
  console.log(e.target.value);
});
...
function submitDetail(e) {
  ...
  console.log("input 1",input1.value)
  console.log("input 2",input2.value)
  console.log("f1 input1",document.getElementById("origin1input1").value)
  console.log("f1 input2",document.getElementById("origin2input2").value)
  input1.value="validation secured"
}
